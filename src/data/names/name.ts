...
import antiguan from './antiguan.json';
import argentinian from './argentinian.json';
import armenian from './armenian.json';
import aruban from './aruban.json';
import asianAmerican from './asianAmerican.json';
import australian from './australian.json';
import austrian from './austrian.json';
import azerbaijani from './azerbaijani.json';
import aztec from './aztec.json';

import bahamian from './bahamian.json';
import bahraini from './bahraini.json';
import bangladeshi from './bangladeshi.json';
import barbadian from './barbadian.json';
import belarusian from './belarusian.json';
import belgian from './belgian.json';
import belizean from './belizean.json';
import beninese from './beninese.json';
import bermudian from './bermudian.json';
import bhutanese from './bhutanese.json';
import bissauGuinean from './bissauGuinean.json';
import bolivian from './bolivian.json';
import bosnian from './bosnian.json';
import brazilian from './brazilian.json';
import british from './british.json';
import bruneian from './bruneian.json';
import bulgarian from './bulgarian.json';
import burkinabe from './burkinabe.json';
import burmese from './burmese.json';
import burundian from './burundian.json';

import cambodian from './cambodian.json';
import cameroonian from './cameroonian.json';
import canadian from './canadian.json';
import capeVerdean from './capeVerdean.json';
import catalan from './catalan.json';
import centralAfrican from './centralAfrican.json';
import chadian from './chadian.json';
import chilean from './chilean.json';
import chinese from './chinese.json';
import colombian from './colombian.json';
import congolese from './congolese.json';
import cookIslander from './cookIslander.json';
import costaRican from './costaRican.json';
import croatian from './croatian.json';
import cuban from './cuban.json';
import curacaoan from './curacaoan.json';
import cypriot from './cypriot.json';
import czech from './czech.json';

import danish from './danish.json';
import djiboutian from './djiboutian.json';
import dominican from './dominican.json';
import dominiqais from './dominiqais.json';
import dutch from './dutch.json';

import eastTimorese from './eastTimorese.json';
import ecuadorian from './ecuadorian.json';
import egyptian from './egyptian.json';
import emirati from './emirati.json';
import equatoguinean from './equatoguinean.json';
import eritrean from './eritrean.json';
import estonian from './estonian.json';
import ethiopian from './ethiopian.json';

import fijian from './fijian.json';
import filipina from './filipina.json';
import finnish from './finnish.json';
import french from './french.json';
import frenchGuianan from './frenchGuianan.json';
import frenchPolynesian from './frenchPolynesian.json';

import gabonese from './gabonese.json';
import gambian from './gambian.json';
import georgian from './georgian.json';
import german from './german.json';
import ghanan from './ghanan.json';
import greek from './greek.json';
import greenlandic from './greenlandic.json';
import grenadian from './grenadian.json';
import guamanian from './guamanian.json';
import guatemalan from './guatemalan.json';
import guinean from './guinean.json';
import guyanese from './guyanese.json';

import haitian from './haitian.json';
import honduran from './honduran.json';
import hungarian from './hungarian.json';

import icelandic from './icelandic.json';
import iKiribati from './iKiribati.json';
import indian from './indian.json';
import indonesian from './indonesian.json';
import iranian from './iranian.json';
import iraqi from './iraqi.json';
import irish from './irish.json';
import israeli from './israeli.json';
import italian from './italian.json';
import ivorian from './ivorian.json';

import jamaican from './jamaican.json';
import japanese from './japanese.json';
import jordanian from './jordanian.json';

import kazakh from './kazakh.json';
import kenyan from './kenyan.json';
import kittitian from './kittitian.json';
import korean from './korean.json';
import kosovan from './kosovan.json';
import kurdish from './kurdish.json';
import kuwaiti from './kuwaiti.json';
import kyrgyz from './kyrgyz.json';

import laotian from './laotian.json';
import latina from './latina.json';
import latvian from './latvian.json';
import lebanese from './lebanese.json';
import liberian from './liberian.json';
import libyan from './libyan.json';
import liechtensteiner from './liechtensteiner.json';
import lithuanian from './lithuanian.json';
import luxembourgian from './luxembourgian.json';

import macedonian from './macedonian.json';
import malagasy from './malagasy.json';
import malawian from './malawian.json';
import malaysian from './malaysian.json';
import maldivian from './maldivian.json';
import malian from './malian.json';
import maltese from './maltese.json';
import marshallese from './marshallese.json';
import mauritanian from './mauritanian.json';
import mauritian from './mauritian.json';
import mexican from './mexican.json';
import micronesian from './micronesian.json';
import moldovan from './moldovan.json';
import monegasque from './monegasque.json';
import mongolian from './mongolian.json';
import montenegrin from './montenegrin.json';
import moroccan from './moroccan.json';
import mosotho from './mosotho.json';
import motswana from './motswana.json';
import mozambican from './mozambican.json';

import namibian from './namibian.json';
import nauruan from './nauruan.json';
import nepalese from './nepalese.json';
import newCaledonian from './newCaledonian.json';
import newZealander from './newZealander.json';
import nicaraguan from './nicaraguan.json';
import nigerian from './nigerian.json';
import nigerien from './nigerien.json';
import niuean from './niuean.json';
import niVanuatu from './niVanuatu.json';
import norwegian from './norwegian.json';

import omani from './omani.json';

import pakistani from './pakistani.json';
import palauan from './palauan.json';
import palestinian from './palestinian.json';
import panamanian from './panamanian.json';
import papuaNewGuinean from './papuaNewGuinean.json';
import paraguayan from './paraguayan.json';
import peruvian from './peruvian.json';
import polish from './polish.json';
import portuguese from './portuguese.json';
import puertoRican from './puertoRican.json';

import qatari from './qatari.json';

import romanian from './romanian.json';
import russian from './russian.json';
import rwandan from './rwandan.json';

import sahrawi from './sahrawi.json';
import saintLucian from './saintLucian.json';
import salvadoran from './salvadoran.json';
import sammarinese from './sammarinese.json';
import samoan from './samoan.json';
import saoTomean from './saoTomean.json';
import saudi from './saudi.json';
import scottish from './scottish.json';
import senegalese from './senegalese.json';
import serbian from './serbian.json';
import seychellois from './seychellois.json';
import sierraLeonean from './sierraLeonean.json';
import singaporean from './singaporean.json';
import slovak from './slovak.json';
import slovene from './slovene.json';
import solomonIslander from './solomonIslander.json';
import somali from './somali.json';
import southAfricanBlack from './southAfricanBlack.json';
import southAfricanWhite from './southAfricanWhite.json';
import southSudanese from './southSudanese.json';
import spanish from './spanish.json';
import sriLankan from './sriLankan.json';
import sudanese from './sudanese.json';
import surinamese from './surinamese.json';
import swazi from './swazi.json';
import swedish from './swedish.json';
import swiss from './swiss.json';
import syrian from './syrian.json';

import taiwanese from './taiwanese.json';
import tajik from './tajik.json';
import tanzanian from './tanzanian.json';
import thai from './thai.json';
import tibetan from './tibetan.json';
import togolese from './togolese.json';
import tongan from './tongan.json';
import trinidadian from './trinidadian.json';
import tunisian from './tunisian.json';
import turkish from './turkish.json';
import turkmen from './turkmen.json';
import tuvaluan from './tuvaluan.json';

import ugandan from './ugandan.json';
import ukrainian from './ukrainian.json';
import uruguayan from './uruguayan.json';
import uzbek from './uzbek.json';

import vatican from './vatican.json';
import venezuelan from './venezuelan.json';
import vietnamese from './vietnamese.json';
import vincentian from './vincentian.json';

import whiteAmerican from './whiteAmerican.json';

import yemeni from './yemeni.json';

import zairian from './zairian.json';
import zambian from './zambian.json';
import zimbabwean from './zimbabwean.json';
